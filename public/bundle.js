...
/***/ function(module, exports, __webpack_require__) {
	...
	var _skillsCloud = __webpack_require__(1);
	
	var _skillsCloud2 = _interopRequireDefault(_skillsCloud);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _d3Cloud = __webpack_require__(3);
	
	var _d3Cloud2 = _interopRequireDefault(_d3Cloud);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var skills = [['HTML5', 4], ['CSS3', 3], ['UI/UX', 5], ['jQuery', 5], ['RWD', 4], ['Bootstrap', 4], ['LESS', 2], ['SASS', 1], ['Ionic', 0.5],
	// 
	['JavaScript', 8], ['ES6', 1], ['React', 1], ['AngularJS', 2], ['Backbone.js', 1], ['TDD', 1], ['CoffeeScript', 1], ['PhoneGap', 1], ['Cordova', 1],
	// 
	['NodeJs', 5], ['PHP', 8], ['Python', 1], ['Scala', 0.5], ['MySQL', 8], ['MongoDB', 1], ['Nginx', 8],
	// 
	['Yii2', 1], ['Express', 1], ['OOP', 5], ['RESTful API', 5], ['Redis', 3], ['Memcache', 5], ['Apache', 8],
	// 
	['Git', 6], ['AWS', 3], ['Google App Engine', 1], ['Docker', 2], ['Agile', 3], ['Scrum', 3], ['Photoshop', 8], ['Sketch', 1], ['TeamCity', 1]];
	
	// Calculate max years of experience
	var maxExperience = Math.max.apply(null, skills.map(function (s) {
	  return s[1];
	}));
	
	console.log(maxExperience);
	var fill = (0, _d.scaleOrdinal)(_d.schemeCategory10);
	var layout = (0, _d3Cloud2.default)().size([500, 500]).words(skills.map(function (d) {
	...
	function draw(words) {
	  (0, _d.select)(".skills-cloud").html('');
	  (0, _d.select)(".skills-cloud").append("svg").attr("width", layout.size()[0]).attr("height", layout.size()[1]).append("g").attr("transform", "translate(" + layout.size()[0] / 2 + "," + layout.size()[1] / 2 + ")").selectAll("text").data(words).enter().append("text").style("font-size", function (d) {
	    return d.size + "px";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var dispatch = __webpack_require__(4).dispatch;
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js!./icons.sass", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js!./icons.sass");
